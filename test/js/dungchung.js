function addsidebarNav() {
  ...
  <div class="iq-sidebar-logo d-flex justify-content-between">
     <a href="index.html" class="header-logo">
        <img src="images/f01af3010ff434d3a12d9aad6508c8db.jpg" class="img-fluid rounded-normal" alt="">
        <div class="logo-title">
           <span class="text-primary text-uppercase">REVIEW BOOK</span>
        </div>
     </a>
  </div>
  <div id="sidebar-scrollbar">
     <nav class="iq-sidebar-menu">
        <ul id="iq-sidebar-toggle" class="iq-menu">
           <li><a href="index.html"><i class="las la-home iq-arrow-left"></i>Trang Chủ</a></li>
           <li>
           ...
           <li><a href="book-page.html"><i class="ri-heart-line"></i>Yêu Thích</a></li>
           <li><a href="book-page.html"><i class="ri-book-line"></i>Sách PDF</a></li>
           <li><a href="../index.html"><i class="ri-login-box-line ml"></i>Đăng xuất</a></li>
        </ul>
     </nav>
  </div>
</div>`);
                     ...
                     <ul class="navbar-nav ml-auto navbar-list">
                        ...
                        <li class="line-height pt-3">
                           <a href="#" class="search-toggle iq-waves-effect d-flex align-items-center">
                              <img src="images/user/anh-cuon-sach-da-mo-ra_051455673.jpg" class="img-fluid rounded-circle mr-3" alt="user">
                              <div class="caption">
                                 <h6 class="mb-1 line-height">Đinh Minh Phương</h6>
                           ...
                           <div class="iq-sub-dropdown iq-user-dropdown">
                              <div class="iq-card shadow-none m-0">
                                 <div class="iq-card-body p-0 ">
                                    ...
                                    <a href="checkout.html" class="iq-sub-card iq-bg-primary-hover">
                                       <div class="media align-items-center">
                                          <div class="rounded iq-card-icon iq-bg-primary">
                                    ...
                                    <a href="book-page.html" class="iq-sub-card iq-bg-primary-hover">
                                       <div class="media align-items-center">
                                          <div class="rounded iq-card-icon iq-bg-primary">
                                    ...
                                    <div class="d-inline-block w-100 text-center p-3">
                                       <a class="bg-primary iq-sign-btn" href="../index.html" role="button">Đăng xuất<i class="ri-logout-box-line ml-2"></i></a>
                                    </div>
                                 </div>
                              </div>
                           </div>
         ...
         <div class="container-fluid">
            <div class="row">
               ...
               <div class="col-lg-6 text-right">
                  Copyright 2023 <a href="#">REVIEW BOOK</a> All Rights Reserved.
               </div>
            </div>
         </div>
      </footer>`);
